...
def _validate_url(url: str) -> tuple[bool, str]:
    """Validate URL: must be http(s) with valid domain, no private/reserved IPs."""
    import ipaddress
    import socket
    ...
    try:
        ...
        try:
            ...
            # Not a raw IP — resolve hostname and check
            ...
            try:
                ...
                for _, _, _, _, sockaddr in resolved:
                    ...
                    if addr.is_private or addr.is_reserved or addr.is_loopback or addr.is_link_local:
                        return False, f"Hostname resolves to private/reserved IP: {hostname}"
